...
import os
#####################################################################
# compute ph for toy data. First generate n points, then sample 1000 points,
# then compute the distance matrix, then compute the PH.

#see the difference between this and compute_ph_toy_resample_after.py
#####################################################################


dataset = "toy_circle_before"  # must be one of toy_circle, toy_sphere, torus, eyeglasses, inter_circles, toy_blob, two_rings
...
sigmas = np.linspace(0.35, 0.60, 51)
